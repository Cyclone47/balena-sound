...
* Delete buffer time [Alex]
* Decrease buffer time [Alex]
* Change file name [Alex]
* Delete double-click sound [Alex]
* Delete click sound [Alex]
* Make loading faster [Alex]
* Fix volume function [Alex]
* Change volume changing code [Alex]
* Fix calculation error [Alex]
* Parse output [Alex]
* Fix detection error [Alex]
* Enable use of variables [Alex]
* Fix volume detection error [Alex]
* Fix error [Alex]
* Replace bluetooth-button [Alex]
* Place bash script starting at the end of start.sh [Alex]
* Fix gpio export error [Alex]
* Change some code [Alex]
* Fix my code [Alex]
* Fix code [Alex]
* make use of BUTTON_VOLUME var [Alex]
* Correct typo [Alex]
* Run bluetooth_button from start.sh [Alex]
* Add some volume code [Alex]
* Update gpio code [Alex]
* Change some values [Alex]
* Add some code [Alex]
* Copy bluetooth-button too in Dockerfile.aarch64 [Alex]
* Add button volume option [Alex]
* Add click sounds [AlexProgrammerDE]
* Rename bluetooth-audio to bluetooth [AlexProgrammerDE]
